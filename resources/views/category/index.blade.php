                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$cate->hasParentCate ? $cate->hasParentCate->name : ""}}</td>
                                <td>{{$cate->hasProducts->count()}}</td>
                                <td>
                                    <a href="{{route('category.edit',['id' =>$cate->id]) }}" class="btn btn-success btn-sm">Edit</a>
                                    <button onclick='confirmDel("{{route('category.delete', ['id' => $cate->id])}}")' data-cate-id="{{$cate->id}}" class="btn btn-danger btn-sm btn-del">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
